...
// tsc's rootDir is src/, so package.json cannot be imported. Bake the version in here
// instead, and let CI's --check catch the case where someone bumps one without the other.
