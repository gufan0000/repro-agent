...
`0.4.3`, protocol `1.0`. The spec, the CLI, the offline page and both adapters are complete, covered by 76 tests (`npm test`) plus 13 real-browser tests (`npm run test:browser`) on Linux, macOS and Windows across Node 20 and 22.
